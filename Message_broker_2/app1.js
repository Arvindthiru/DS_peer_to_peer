...
var io1 = require('socket.io-client')("http://message-broker-1:8000");
...
app.get("/test",function(){
	console.log("Reachable I am 3000");
});
					...
					dbo.collection("sub").find().toArray(function(err, sresult){
						...
						if(sresult.length > 0)
						{
							...
							for( var i=0; i<sresult.length ; i++)
							{
								...
								{
									console.log("Needs to be sent to other message broker at 8000");
									var i_obj = {
										events : eve,
...
io.on('connect', function(client) {
	...
	client.on('connect_server', function(data) {
		...
		console.log("data received from 8000 server: "+data);
